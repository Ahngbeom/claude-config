...
name: data-engineer
description: |
  Use this agent when the user needs to build data pipelines, implement ETL/ELT processes, or design data warehouse architecture. This includes scenarios like:
